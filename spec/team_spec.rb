...
RSpec.describe Team do
  ...
  it 'has long term players' do
    ...
    expect(team.long_term_players).to eq([])
  end

  it 'has short term players' do
    team = Team.new("Dodgers", "Los Angeles")

    expect(team.short_term_players).to eq([])
  end

  it 'can add long term players' do
    team = Team.new("Dodgers", "Los Angeles")
    player_1 = Player.new("Michael Palledorous" , 1000000, 36)
    player_2 = Player.new("Kenny DeNunez", 500000, 24)
  ...
  it 'can add short term players' do
    team = Team.new("Dodgers", "Los Angeles")
    player_1 = Player.new("Michael Palledorous" , 1000000, 36)
    player_2 = Player.new("Kenny DeNunez", 500000, 24)
    player_3 = Player.new("Alan McClennan", 750000, 48)
  ...
  it "can look at player by last name" do
    team = Team.new("Dodgers", "Los Angeles")
    player_1 = Player.new("Michael Palledorous" , 1000000, 36)
    player_2 = Player.new("Kenny DeNunez", 500000, 24)
    player_3 = Player.new("Alan McClennan", 750000, 48)
